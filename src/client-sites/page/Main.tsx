                ...
                <div>
                  <div className="grid grid-cols-4 grid-flow-row">
                    ...
                    <div className="col-span-2 p-2 md:p-5">
                      <p className="font-kanit xs:text-xl md:text-4xl">{data.name}</p>
                      <div className="flex">
                        <p className="font-kanit text-sm md:text-1xl text-blue-700">
                          {data.address}
                        </p>
                      </div>
                      <p className="font-kanit text-sm md:text-1xl text-gray-500 truncate">
                        {data.about}
                      </p>
                    </div>
                    <div className="grid grid-flow-rows md:grid-rows-6 p-2 md:p-5 border-l border-[#D8D8D8]">
                      ...
                      <div className="font-kanit text-sm md:text-1xl md:row-span-1 text-right">
                        {data.review} รีวิว
                      </div>
                      <div className="font-kanit text-sm md:text-1xl md:row-span-1  md:ml-28 bg-red-500 text-right my-auto text-white ">
                        {/* {data.discount > 0 ? (
                      ...
                      <div className="font-kanit text-sm md:text-1xl md:row-span-2 text-right">
                        <div>ราคาเริ่มต้น (ต่อคืน)</div>
                        <div className="text-red-500 md:text-[30px] font-bold">
                          ฿ 2000
                        </div>
                      </div>
                      <button className="font-kanit bg-blue-500 hover:bg-blue-700 text-sm md:row-span-1  text-white font-bold rounded">
                        รายระเอียดเพิ่มเติม
                      </button>
                    </div>
                  </div>
