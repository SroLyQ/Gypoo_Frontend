  ...
  return (
    ...
    <div>{
        ...
        <form className="pt-4" onSubmit={e=>{sendForm(e)}} >
          ...
          <button type="submit"  className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 md:py-1 mt-2 text-base md:text-sm rounded-full">ยืนยัน</button>
          </div>
        </form>
      </div>
      </div> : 
      <div className="block w-screen ">
        ...
        <div className=" rounded-lg my-4 mx-auto bg-slate-300 md:w-32 sm:w-16 w-2/5 ">
              <div className="text-center md:text-base sm:text-sm text-lg">ผู้ให้บริการห้องพัก</div>
        </div>
        </div>
        <div className=" mx-auto border-2 border-black-900 w-2/3 rounded-lg md:px-16 sm:px-12 px-10 py-10  ">
          <div className="flex  justify-between w-auto ">
          ...
          <div className="border-b-2 border-black-900 pb-4 mt-1 md:mt-2 md-2 ">
          </div>
          <div className="flex mt-4 ">
            <div className="mr-6 sm:mr-8 hidden md:block">
            <img src = "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/67abf060-d47c-4593-9655-19533a29e467/dew31gr-65edb5db-42ad-4c1d-af4f-637aa7d555f8.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..GyaK76NJ2JwRCx017QDOfMD3WdZhmxEqr9bijyidgHM" className="rounded-full md:h-40 sm:h-18 h-18 "/>
